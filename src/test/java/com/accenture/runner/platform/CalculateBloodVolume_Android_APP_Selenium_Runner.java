 ...
 *
 */
public class CalculateBloodVolume_Android_APP_Selenium_Runner {
  ...
  public static void runOnceBeforeClass() {
	...
	CTLogger.writeToLog("CalculateBloodVolume_Android_APP_Selenium_Runner MAP AFTER - " + ExtentTestManager.extentTestMap.size() + "Thread id - " + Thread.currentThread().getId());
  }
  ...
  public static void runOnceAfterClass() {
	CTLogger.writeToLog("@@AfterClass - CalculateBloodVolume_Android_APP_Selenium_Runner");
