...
public class ExecuteScriptKkartPurchaseGamesSauceLabRunner implements SauceOnDemandSessionIdProvider{
	 ...
	 */
     public String scriptName = "konakart purchaseGamesSauceLab";
	  ...
	  /**
	    ...
	    public void setUp() throws Exception {
	    	...
	    	ExtentTestManager.startTest("Platform Test - SauceLab <b>"
	    			+os+"-"+browser+"-"+version+"</b> : " + scriptName, "Online Store - Konakart PurchaseGamesSauceLab", "com.accenture.runner.platform.ExecuteScriptKkartPurchaseGamesSauceLabRunner");
