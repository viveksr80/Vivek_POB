...
public class ExecuteScriptKkartPurchaseComputerPheripheralSauceLabRunner implements SauceOnDemandSessionIdProvider {
	 ...
	 */
	public String scriptName = "konakart purchaseComputerPheripheralSauceLab";
	...
	public void setUp() throws Exception {
		...
		ExtentTestManager.startTest("Platform Test - SauceLab <b>" + os + "-" + browser + "-" + version + "</b> : " + scriptName,
				"Online Store - Konakart PurchaseComputerPheripheralSauceLab","com.accenture.runner.platform.ExecuteScriptKkartPurchaseComputerPheripheralSauceLabRunner");
