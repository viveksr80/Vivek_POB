...
public class ExecuteScriptKkartPurchaseGiftSauceLabRunner implements SauceOnDemandSessionIdProvider{
	 ...
	 */
	  public String scriptName = "konakart purchaseGiftSauceLab";
	  ...
	  /**
	    ...
	    public void setUp() throws Exception {
	    	...
	    	ExtentTestManager.startTest("Platform Test - SauceLab <b>"
	    			+os+"-"+browser+"-"+version+"</b> : " + scriptName, "Online Store - Konakart PurchaseGiftSauceLab", "com.accenture.runner.platform.ExecuteScriptKkartPurchaseGiftSauceLabRunner");
