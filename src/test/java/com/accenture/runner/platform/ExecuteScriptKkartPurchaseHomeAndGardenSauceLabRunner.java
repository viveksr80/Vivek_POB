...
public class ExecuteScriptKkartPurchaseHomeAndGardenSauceLabRunner implements SauceOnDemandSessionIdProvider{
	 ...
	 */
	  public String scriptName = "konakart purchaseHomeAndGardenSauceLab";
	  ...
	  /**
	    ...
	    public void setUp() throws Exception {
	    	...
	    	ExtentTestManager.startTest("Platform Test - SauceLab <b>"
	    			+os+"-"+browser+"-"+version+"</b> : " + scriptName, "Online Store - Konakart PurchaseHomeAndGardenSauceLab", "com.accenture.runner.platform.ExecuteScriptKkartPurchaseHomeAndGardenSauceLabRunner");
