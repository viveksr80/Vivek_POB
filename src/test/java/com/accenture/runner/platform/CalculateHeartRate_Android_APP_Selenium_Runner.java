 ...
 *
 */
public class CalculateHeartRate_Android_APP_Selenium_Runner {
  ...
  public static void runOnceBeforeClass() {
	...
	CTLogger.writeToLog("CalculateHeartRate_Android_APP_Selenium_Runner MAP AFTER - " + ExtentTestManager.extentTestMap.size() + "Thread id - " + Thread.currentThread().getId());
  }
  ...
  public static void runOnceAfterClass() {
	CTLogger.writeToLog("@@AfterClass - CalculateHeartRate_Android_APP_Selenium_Runner");
