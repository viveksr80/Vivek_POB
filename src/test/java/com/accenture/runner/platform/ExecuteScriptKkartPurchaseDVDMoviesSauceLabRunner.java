...
public class ExecuteScriptKkartPurchaseDVDMoviesSauceLabRunner implements SauceOnDemandSessionIdProvider{
   ...
   public SauceOnDemandTestWatcher resultReportingTestWatcher = new SauceOnDemandTestWatcher(this, authentication);
	 ...
	 */	  static String scriptName = "konakart purchaseDVDMoviesSauceLab";
	  ...
	  /**
	    ...
	    public void setUp() throws Exception {
	    	...
	    	ExtentTestManager.startTest("Platform Test - SauceLab <b>"
	    			+os+"-"+browser+"-"+version+"</b> : " + scriptName, "Online Store - Konakart PurchaseDVDMoviesSauceLab", "com.accenture.runner.platform.ExecuteScriptKkartPurchaseDVDMoviesSauceLabRunner");
