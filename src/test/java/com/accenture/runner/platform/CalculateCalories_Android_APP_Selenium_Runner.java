 ...
 *
 */
public class CalculateCalories_Android_APP_Selenium_Runner {
  ...
  public void test() {
	...
	executeScript.executeScript(scriptName, "","","saucelabs_app_" + prop.getValue("MOBILE_DEVICE_NAME"),"");
  }
  ...
  public static void runOnceBeforeClass() {
	...
	CTLogger.writeToLog("CalculateCalories_Android_APP_Selenium_Runner MAP AFTER - " + ExtentTestManager.extentTestMap.size() + "Thread id - " + Thread.currentThread().getId());
  }
  ...
  public static void runOnceAfterClass() {
	CTLogger.writeToLog("@@AfterClass - CalculateCalories_Android_APP_Selenium_Runner");
