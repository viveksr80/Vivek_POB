...
public class ExecuteScriptKkartPurchaseSoftwareSauceLabRunner implements SauceOnDemandSessionIdProvider{
	 ...
	 */
	  public String scriptName = "konakart purchaseSoftwareSauceLab";
	  ...
	  /**
	    ...
	    public void setUp() throws Exception {
	    	...
	    	ExtentTestManager.startTest("Platform Test - SauceLab <b>"
	    			+os+"-"+browser+"-"+version+"</b> : " + scriptName, "Online Store - Konakart PurchaseSoftwareSauceLab", "com.accenture.runner.platform.ExecuteScriptKkartPurchaseSoftwareSauceLabRunner");
