...
@CucumberOptions(features = "target/test-classes/cucumber/features/", tags = { "@dvdmovies" }, format = { "html:target/cucumber-report/software" }, glue = { "cucumber.stepdefs",
    "cucumber.stepdefs.KKPurchaseElectronics" })
public class KKPurchaseElectronicsRunner {
	
	  //Added as part of Live Reporting
  public static String RUNNER_SLNO;

  static ExtentReports extent;
  static String scriptName = "konakart purchaseElectronics";
  ...
  public static void runOnceBeforeClass() {
	...
	ExtentTestManager.startTest("Cucumber Test : " + scriptName, "Online Store - konakart purchaseElectronics", "com.accenture.runner.bdd.KKPurchaseElectronicsRunner");
	CTLogger.writeToLog("KKPurchaseElectronicsRunner MAP AFTER - " + ExtentTestManager.extentTestMap.size() + "Thread id - " + Thread.currentThread().getId());
  }
  ...
  public static void runOnceAfterClass() {
	CTLogger.writeToLog("@@AfterClass - KKPurchaseElectronicsRunner");
