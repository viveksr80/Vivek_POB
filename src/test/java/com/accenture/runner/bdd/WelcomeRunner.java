...
glue = { "cucumber.stepdefs", "cucumber.stepdefs.Welcome" })
public class WelcomeRunner {
	static ExtentReports extent;
	static String scriptName = "Welcome";


@BeforeClass
public static void runOnceBeforeClass() {
	extent = ExtentManager.getExtentManager();
	ExtentTestManager.startTest("Cucumber Test : " + scriptName, "Welcome");
	CTLogger.writeToLog("@BeforeClass Welcome extent - "+extent);
 }


@AfterClass
public static void runOnceAfterClass() {
	CTLogger.writeToLog("@AfterClass Welcome extent - "+extent);
