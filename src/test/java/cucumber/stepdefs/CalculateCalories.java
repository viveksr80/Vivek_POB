...
public class CalculateCalories {
  ...
  String scriptName = "CalculateCalories";
  String scenario = scriptName + " Calculating Calories for a person";
  ...
  public CalculateCalories() {
	...
	try {
	  ...
	  CTLogger.writeToLog("CalculateCalories extentTest - " + extentTest);
	  ...
	  try {
		ex.printStackTrace();
		CTLogger.writeToLog("CalculateCalories", "constructor called", " exception occured");
   ...
   */
  @Given("^I am on the HealtCalculator App for Calories calc \"([^\"]*)\"$")
  public void i_am_on_the_HealtCalculator_App_for_Calories_calc(String arg1) throws Throwable {
	CTLogger.writeToLog("i_am_on_the_HealtCalculator_App_for_Calories_calc");
  ...
  /**
   * Method is used to select Calories from the options
   *
   * @throws Throwable - represents exception
   */
  @When("^I select Calories from the options$")
  public void i_select_Calories_from_the_options() throws Throwable {
	CTLogger.writeToLog("i_select_Calories_from_the_options");
	pageObj.openHealtCalculatorApp(objectMap, "Calories");
  }

  /**
   * Method is used to provide the necessary details for calories calculation
   *
   * @throws Throwable - represents exception
   */
  @When("^I provided the necessary details for Calories calc and clicked Calculate$")
  public void i_provided_the_necessary_details_for_Calories_calc_and_clicked_Calculate() throws Throwable {
	CTLogger.writeToLog("i_provided_the_necessary_details_for_Calories_calc_and_clicked_Calculate");
	pageObj.executeHealtCalculatorApp(objectMap, voList, "Calories");
  }

  /**
   * Method is used to calculated calories result
   *
   * @throws Throwable - represents exception
   */
  @Then("^I should see the calculated Calories result$")
  public void i_should_see_the_calculated_Calories_result() throws Throwable {
	CTLogger.writeToLog("i_should_see_the_calculated_Calories_result");
	pageObj.verifyHealtCalculatorApp(objectMap, "Calories");
	driver.quit();
  }
