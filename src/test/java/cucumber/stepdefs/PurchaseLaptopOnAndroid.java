 ...
 *
 */
public class PurchaseLaptopOnAndroid {
   ...
   * Constructor
   */
  public PurchaseLaptopOnAndroid() {
	...
	try {
	  ...
	  extentTest.log(LogStatus.INFO, "Starting test PurchaseLaptopOnAndroid");
	  CTLogger.writeToLog("PurchaseLaptopOnAndroid extentTest - " + extentTest);
	  ...
	  try {
		ex.printStackTrace();
		CTLogger.writeToLog("PurchaseLaptopOnAndroid", "constructor called", " exception occured");
	  } finally {
   ...
   * 
   */
  @Given("^I am on website in Android device \"([^\"]*)\"$")
  public void i_am_on_website_in_Android_device(String arg1) throws Throwable {
	CTLogger.writeToLog("i_am_on_website_in_IOS_device");
	launchUrlPO.launchUrl(url);
  }

  /**
   * Method is used to select laptop from electronic category in android device
   *
   * @throws Throwable - represents exception
   * 
   */
  @When("^I select Laptop from Electronic Category in Android device$")
  public void i_select_Laptop_from_Electronic_Category_in_Android_device() throws Throwable {
  ...
  /**
   * Method is used to add laptop to cart and checkout in android device
   *
   * @throws Throwable - represents exception
   */
  @When("^Add Laptop to cart and Checkout in Android device$")
  public void add_Laptop_to_cart_and_Checkout_in_Android_device() throws Throwable {
  ...
  /**
   * Method is used to provide billing details and shipping address for laptop checkout in android device
   *
   * @throws Throwable - represents exception
   */
  @When("^Provide billing details and shipping address for Laptop checkout in Android device$")
  public void provide_billing_details_and_shipping_address_for_Laptop_checkout_in_Android_device() throws Throwable {
  ...
  /**
   * Method is used to verify purchase confirmation page in Android device
   *
   * @throws Throwable - represents exception
   */
  @Then("^I should be on the purchase confirmation page in Android device$")
  public void i_should_be_on_the_purchase_confirmation_page_in_Android_device() throws Throwable {
	try {
