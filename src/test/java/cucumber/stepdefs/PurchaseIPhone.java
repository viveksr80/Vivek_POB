...
public class PurchaseIPhone {
  ...
  String scenario = scriptName + "_Purchase iPhone";
  String objectMapFile = "store-domeqa.xls";
  String productName = "iPhones";
   ...
   */
	public PurchaseIPhone() {
		...
		try {
			...
			extentTest.log(LogStatus.INFO, "Starting test PurchaseIPhone");
			CTLogger.writeToLog("PurchaseIPhone extentTest - " + extentTest);
			...
			testDataMap = excelTestDataReader.readTestData("Purchase IPhone");
			...
			try {
				ex.printStackTrace();
				CTLogger.writeToLog("PurchaseIPhone", "constructor called", " exception occured");
   ...
   */
  @Given("^I am on store website \"([^\"]*)\"$")
  public void I_am_on_store_website(String arg1) throws Throwable {

	CTLogger.writeToLog("I_am_on_store_website");
  ...
  /**
   * Method is used to select iPhone from product category
   *
   * @throws Throwable - represents exception
   */
  @When("^I select iPhone from Product Category$")
  public void I_select_iPhone_from_Product_Category() throws Throwable {
	CTLogger.writeToLog("I_select_iPhone_from_Product_Category");
	productCategoryPO.selectProductFromCategory(obectMap.get("ProductCategory"), productName);
  }

  /**
   * Method is used to add iPhone to cart and checkout
   *
   * @throws Throwable - represents exception
   */
  @And("^Add iPhone to cart and Checkout$")
  public void Add_iPhone_to_cart_and_Checkout() throws Throwable {
	CTLogger.writeToLog("Add_iPad_to_cart_and_Checkout");

	CTLogger.writeToLog("Add_iPhone_to_cart_and_Checkout");
  ...
  /**
   * Method is used to provide billing details and shipping address for iPhone checkout
   *
   * @throws Throwable - represents exception
   */
  @And("^Provide billing details and shipping address for iPhone checkout$")
  public void Provide_billing_details_and_shipping_address_for_iPhone_checkout() throws Throwable {

	CTLogger.writeToLog("Provide_billing_details_and_shipping_address_for_iPhone_checkout");
	billingDetailsPO.billingDetails(obectMap, voList);

  }

  /**
   * Method is used to verify iPhone confirmation page
   *
   * @throws Throwable - represents exception
   */
  @Then("^I should be on the Purchase iPhone confirmation page$")
  public void I_should_be_on_the_Purchase_iPhone_confirmation_page() throws Throwable {
	try {
	  ...
	  if (status.equals("true")) {
		extentTest.log(LogStatus.PASS, "I_should_be_on_the_Purchase_iPhone_confirmation_page() - " + "text matched");
	  } else {
		extentTest.log(LogStatus.PASS, "I_should_be_on_the_Purchase_iPhone_confirmation_page() - " + "text mismatch");
	  }
