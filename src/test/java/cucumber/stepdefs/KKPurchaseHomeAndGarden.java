 ...
 *
 */
public class KKPurchaseHomeAndGarden {
   ...
   * Constructor
   */
	public KKPurchaseHomeAndGarden() {
		...
		try {
			...
			extentTest.log(LogStatus.INFO, "Starting test konakart purchaseHomeAndGarden");
			...
			testDataMap = excelTestDataReader.readTestData("konakart purchaseHomeAndGarden");
			...
			try {
				ex.printStackTrace();
				CTLogger.writeToLog("KKPurchaseHomeAndGarden", "constructor called", " exception occured");
  ...
  /**
   * Method is used to login to konkart home and garden store
   *
   * @param arg1 - represents dummy argument
   * @throws Throwable - represents exception
   */
  @Given("^I Login to Konkart homeandgarden store \"([^\"]*)\"$")
  public void I_Login_to_Konkart_homeandgarden_store(String arg1) throws Throwable {

	CTLogger.writeToLog("I_Login_to_homeandgarden_software_store");
  ...
  /**
   * Method is used to select home and garden
   *
   * @throws Throwable - represents exception
   */
  @When("^I select homeandgarden$")
  public void I_select_homeandgarden() throws Throwable {

	CTLogger.writeToLog("I_select_homeandgarden");

	objectMapVO = objectMap.get("clickOnHomeAndGarden");
	click.click(driver, objectMapVO.getObjectPath(), objectMapVO.getSelector(), extentTest, objectMapVO.getControlName());

	objectMapVO = objectMap.get("clickOnKitchen");
	click.click(driver, objectMapVO.getObjectPath(), objectMapVO.getSelector(), extentTest, objectMapVO.getControlName());

	objectMapVO = objectMap.get("clickOnBrabantia");
	click.click(driver, objectMapVO.getObjectPath(), objectMapVO.getSelector(), extentTest, objectMapVO.getControlName());
  }

  /**
   * Method is used to add home and garden to cart and checkout
   *
   * @throws Throwable - represents exception
   */
  @And("^Add homeandgarden to cart and checkout$")
  public void Add_softwares_to_cart_and_checkout() throws Throwable {

	CTLogger.writeToLog("Add_homeandgarden_to_cart_and_checkout");
  ...
  /**
   * Method is used to edit billing details for home and garden and checkout
   *
   * @throws Throwable - represents exception
   */
  @And("^Edit billing details for homeandgarden checkout$")
  public void Edit_billing_details_for_homeandgarden_checkout() throws Throwable {

	CTLogger.writeToLog("Edit_billing_details_for_homeandgarden_checkout");
  ...
  /**
   * Method is used to purchase home and garden and confirm
   *
   * @throws Throwable - represents exception
   */
