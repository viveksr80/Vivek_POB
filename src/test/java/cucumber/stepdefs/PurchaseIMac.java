...
public class PurchaseIMac {
  ...
  String scenario = scriptName + "_Purchase iMac";
  String objectMapFile = "store-domeqa.xls";
  String productName = "iMacs";
  ...
  public PurchaseIMac() {
	...
	try {
	  ...
	  extentTest.log(LogStatus.INFO, "Starting test PurchaseIMac");
	  CTLogger.writeToLog("PurchaseIMac extentTest - " + extentTest);
	  ...
	  testDataMap = excelTestDataReader.readTestData("Purchase IMac");
	  ...
	  try {
		ex.printStackTrace();
		CTLogger.writeToLog("PurchaseIMac", "constructor called", " exception occured");
  ...
  public void I_am_on_website(String arg1) throws Throwable {
	...
	CTLogger.writeToLog("I_am_on_website");
  ...
  /**
   * Method is used to select iMac from product category
   *
   * @throws Throwable - represents exception
   */
  @When("^I select iMac from Product Category$")
  public void I_select_iMac_from_Product_Category() throws Throwable {

	CTLogger.writeToLog("I_select_iMac_from_Product_Category");
	productCategoryPO.selectProductFromCategory(obectMap.get("ProductCategory"), productName);
  }

  /**
   * Method is used to add iMac to cart and checkout
   *
   * @throws Throwable - represents exception
   */
  @And("^Add iMac to cart and Checkout$")
  public void Add_iMac_to_cart_and_Checkout() throws Throwable {

	CTLogger.writeToLog("Add_iMac_to_cart_and_Checkout");
  ...
  /**
   * Method is used to provide billing details and shipping address for iMac checkout
   *
   * @throws Throwable - represents exception
   */
  @And("^Provide billing details and shipping address for iMac checkout$")
  public void Provide_billing_details_and_shipping_address_for_iMac_checkout() throws Throwable {

	CTLogger.writeToLog("Provide_billing_details_and_shipping_address_for_iMac_checkout");
	billingDetailsPO.billingDetails(obectMap, voList);

  }

  /**
   * Method is used to verify iMac confirmation page
   *
   * @throws Throwable - represents exception
   */
  @Then("^I should be on the Purchase iMac confirmation page$")
  public void I_should_be_on_the_Purchase_iMac_confirmation_page() throws Throwable {
	try {
	  ...
	  if (status.equals("true")) {
		extentTest.log(LogStatus.PASS, "I_should_be_on_the_Purchase_iMac_confirmation_page() - " + "text matched");
	  } else {
		extentTest.log(LogStatus.PASS, "I_should_be_on_the_Purchase_iMac_confirmation_page() - " + "text mismatch");
	  }
